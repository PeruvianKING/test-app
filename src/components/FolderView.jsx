...
import { AlertCircle, Play, Globe } from 'lucide-react';
                    ...
                    <div className="text-center mb-12">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <a
                                ...
                                aria-label="GitHub"
                                className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white hover:text-white rounded-full transition-all duration-300 shadow-lg hover:shadow-indigo-500/50 transform hover:scale-110"
                            >
                            ...
                            <a
                                href="https://peruvianking.com"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Web Principal"
                                className="inline-flex items-center justify-center w-12 h-12 bg-white text-gray-800 border-2 border-transparent hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110"
                            >
                                <Globe className="w-6 h-6 text-indigo-600 transition-colors" />
                            </a>
                        </div>
                    </div>
                </div>
